...
\begin{figure*}[htb]
    ...
    \caption{\emph{Top Left:} The photometric binary function for the 
        inclusive photometric binary threshold (\(\Delta K < -0.2\) mag). The 
        ...
        (\(\Delta K < -0.3\) mag). \emph{Bottom left:} The period distribution of the photometric binary (solid green) 
