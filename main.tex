...
\begin{figure*}
    ...
    dots. Rapid rotators with \(\vsini > 10 \kms\) are denoted as dark blue 
    circles, while stars with marginally detected rotation \(7 \kms < \vsini 
    < 10 \kms\) are denoted with light blue circles. Objects showing rapid
    (\(P_{rot} < 3 \) day) photometric rotation are indicated with purple
    diamonds. Objects showing double-lined APOGEE spectra are indicated as 
    salmon stars. The dotted vertical 
