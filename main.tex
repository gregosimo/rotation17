...
\begin{figure*}[htb]
    ...
    \caption{\emph{Top Left to Bottom Right:} Vertical displacement of cool 
        ...
        \(7--10\) days, \(1.5--7\) days, and less than 1.5 days. Pink stars denote 
...
\begin{figure*}[htb]
    ...
    \caption{\emph{Top Left to Bottom Right:} Vertical displacement of all 
        ...
        \(7--10\) days, \(1.5--7\) days, and less than 1.5 days. Pink stars 
...
number of objects analyzed by McQuillan and in the EB catalog. The predicted EB 
...
to reconstruct the instrinsic mass-ratio distribution of tidally-synchronized 
...
interpeting gyrochronology in the \Kepler{} field. Attempting to characterize
