...
One potential factor which can increase the observed photometric binary
...
function in \cref{fig:photometric_massratio}. As expected, the observed
mass-function increases because of the larger volume of binaries, but the 
photometric binary fraction after accounting for Malmquist bias only increases
to 45\%. We note that this is also an upper limit to the effect because the
true spatial density of the \Kepler{} field should encounter an expoential
dropoff, which would reduce the number of distant photometric binaries.



This contradiction requires that either our assumption of a flat mass-ratio 
function cannot hold, or that there are selection effects in the sample. We 
find that the median distance of the photometric single stars is 509 pc, while 
the median distance of the photometric binaries is 653 pc, consistent with 
photometric binaries being detected to a larger volume than photometric 
singles. Attempting to reconstruct the intrinsic mass-ratio distribution of 
tidally-synchronized binaries is beyond the scope of this analysis.
