...
the Sloan Digital Sky Survey \citep{Blanton17} as APOGEE-2. \gc{Fill in science
...
excluded. \gc{Do I need a full accounting of why certain objects were not
...
of 0.3 mas \citep{Lindegren18} \gc{Since I'm converting to distance modulus
...
example, the median fractional uncertainty in the distance is \gc{NUM}.
...
upper limits reported because of blending contamination. \gc{Typical K error} 
...
typical values of \(A_V\) are \gc{NUM} with a median uncertainty of \gc{NUM}.
...
\kms{} \citep{Bruntt10a,Bruntt10b}. \gc{Check this number more carefully.} The
number of APOGEE targets overlapping with \citet{Bruntt12} is \gc{NUM}.
...
dex (Holtzmann et al.\ in prep). \gc{What did Serenelli et al (2017) say about
